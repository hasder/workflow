...
server.on('request',function(req, res) {
	if (req.method == 'PUT') {
		...
		console.log('PUT' + JSON.stringify(instructions2));
		message.text = instructions2;//JSON.parse(req.payload);
		...
		console.log('POST' +  JSON.stringify(payloadObject[0]));
		message.text = payloadObject[0];
