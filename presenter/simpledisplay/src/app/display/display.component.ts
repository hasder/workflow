  ...
  template: `
    <div>
      ...
      <tr *ngFor="let inst of instructions">
        <td style="text-align:center;font-size:2.0em;">{{inst.status}}</td>
        <td style="text-align:center;font-size:2.0em;">{{inst.text}}</td>
        <td style="text-align:center;font-size:2.0em;">{{inst.count}}</td>
        <td style="text-align:center;font-size:2.0em;">{{inst.image}}</td>
        <td style="text-align:center;font-size:2.0em;">{{inst.progress}}</td>
      </tr>
