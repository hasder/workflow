...
public class Machine extends MachineTemplate implements Observer {
	...
	public class PullWorkorderState extends State {
		...
		public String action(Object arg) {
			...
			//get the singleton RetrieveWorkOrder service interface
			//make the request for the work order information
			//perform and processing and store as workInstructions
			
			//While the work order service interface is not yet complete this will dummy a few work instructions
			workInstructions = TestData.getStaticWorkOrderData();
	...
	public class UpdatePresentationState extends State {
		...
		public String action(Object arg) {
			...
			//this is temporary static presentation. this should be generated by parsing the work instructions and updating the screen
